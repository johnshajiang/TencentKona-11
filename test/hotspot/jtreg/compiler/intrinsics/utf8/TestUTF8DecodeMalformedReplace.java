...
/*
 * @test
 * @run main/othervm -Xint TestUTF8DecodeMalformedReplace
 * @run main/othervm -Xint TestUTF8DecodeMalformedReplace prefix1
 * @run main/othervm -Xint TestUTF8DecodeMalformedReplace prefix2
 *
 * @run main/othervm -XX:+IgnoreUnrecognizedVMOptions -XX:UseAVX=0 -XX:-UseSSE42Intrinsics -XX:-TieredCompilation -Xcomp -XX:CompileCommand=compileonly,*::decodeArrayLoop TestUTF8DecodeMalformedReplace
 * @run main/othervm -XX:+IgnoreUnrecognizedVMOptions -XX:UseAVX=1 -XX:-TieredCompilation -Xcomp -XX:CompileCommand=compileonly,*::decodeArrayLoop TestUTF8DecodeMalformedReplace
 * @run main/othervm -XX:+IgnoreUnrecognizedVMOptions -XX:UseAVX=2 -XX:-TieredCompilation -Xcomp -XX:CompileCommand=compileonly,*::decodeArrayLoop TestUTF8DecodeMalformedReplace
 * @run main/othervm -XX:+IgnoreUnrecognizedVMOptions -XX:UseAVX=0 -XX:-UseSSE42Intrinsics -XX:-TieredCompilation -Xcomp -XX:CompileCommand=compileonly,*::decodeArrayLoop TestUTF8DecodeMalformedReplace prefix1
 * @run main/othervm -XX:+IgnoreUnrecognizedVMOptions -XX:UseAVX=1 -XX:-TieredCompilation -Xcomp -XX:CompileCommand=compileonly,*::decodeArrayLoop TestUTF8DecodeMalformedReplace prefix1
 * @run main/othervm -XX:+IgnoreUnrecognizedVMOptions -XX:UseAVX=2 -XX:-TieredCompilation -Xcomp -XX:CompileCommand=compileonly,*::decodeArrayLoop TestUTF8DecodeMalformedReplace prefix1
 * @run main/othervm -XX:+IgnoreUnrecognizedVMOptions -XX:UseAVX=0 -XX:-UseSSE42Intrinsics -XX:-TieredCompilation -Xcomp -XX:CompileCommand=compileonly,*::decodeArrayLoop TestUTF8DecodeMalformedReplace prefix2
 * @run main/othervm -XX:+IgnoreUnrecognizedVMOptions -XX:UseAVX=1 -XX:-TieredCompilation -Xcomp -XX:CompileCommand=compileonly,*::decodeArrayLoop TestUTF8DecodeMalformedReplace prefix2
 * @run main/othervm -XX:+IgnoreUnrecognizedVMOptions -XX:UseAVX=2 -XX:-TieredCompilation -Xcomp -XX:CompileCommand=compileonly,*::decodeArrayLoop TestUTF8DecodeMalformedReplace prefix2
 *
 * @run main/othervm -XX:+IgnoreUnrecognizedVMOptions -XX:UseAVX=0 -XX:-UseSSE42Intrinsics -XX:TieredStopAtLevel=1 -Xcomp -XX:CompileCommand=compileonly,*::decodeArrayLoop TestUTF8DecodeMalformedReplace
 * @run main/othervm -XX:+IgnoreUnrecognizedVMOptions -XX:UseAVX=1 -XX:TieredStopAtLevel=1 -Xcomp -XX:CompileCommand=compileonly,*::decodeArrayLoop TestUTF8DecodeMalformedReplace
 * @run main/othervm -XX:+IgnoreUnrecognizedVMOptions -XX:UseAVX=2 -XX:TieredStopAtLevel=1 -Xcomp -XX:CompileCommand=compileonly,*::decodeArrayLoop TestUTF8DecodeMalformedReplace
 * @run main/othervm -XX:+IgnoreUnrecognizedVMOptions -XX:UseAVX=0 -XX:-UseSSE42Intrinsics -XX:TieredStopAtLevel=1 -Xcomp -XX:CompileCommand=compileonly,*::decodeArrayLoop TestUTF8DecodeMalformedReplace prefix1
 * @run main/othervm -XX:+IgnoreUnrecognizedVMOptions -XX:UseAVX=1 -XX:TieredStopAtLevel=1 -Xcomp -XX:CompileCommand=compileonly,*::decodeArrayLoop TestUTF8DecodeMalformedReplace prefix1
 * @run main/othervm -XX:+IgnoreUnrecognizedVMOptions -XX:UseAVX=2 -XX:TieredStopAtLevel=1 -Xcomp -XX:CompileCommand=compileonly,*::decodeArrayLoop TestUTF8DecodeMalformedReplace prefix1
 * @run main/othervm -XX:+IgnoreUnrecognizedVMOptions -XX:UseAVX=0 -XX:-UseSSE42Intrinsics -XX:TieredStopAtLevel=1 -Xcomp -XX:CompileCommand=compileonly,*::decodeArrayLoop TestUTF8DecodeMalformedReplace prefix2
 * @run main/othervm -XX:+IgnoreUnrecognizedVMOptions -XX:UseAVX=1 -XX:TieredStopAtLevel=1 -Xcomp -XX:CompileCommand=compileonly,*::decodeArrayLoop TestUTF8DecodeMalformedReplace prefix2
 * @run main/othervm -XX:+IgnoreUnrecognizedVMOptions -XX:UseAVX=2 -XX:TieredStopAtLevel=1 -Xcomp -XX:CompileCommand=compileonly,*::decodeArrayLoop TestUTF8DecodeMalformedReplace prefix2
 * @summary test replace mode case for UTF8 decoder
 */
...
public class TestUTF8DecodeMalformedReplace {
    ...
    static void PrintStringInUTF16(String s) {
