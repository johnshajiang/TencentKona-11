...
/*
 * @test
 * @run main/othervm -Xint TestUTF8DecodeMalformedIgnore
 * @run main/othervm -Xint TestUTF8DecodeMalformedIgnore prefix1
 * @run main/othervm -Xint TestUTF8DecodeMalformedIgnore prefix2
 *
 * @run main/othervm -XX:+IgnoreUnrecognizedVMOptions -XX:UseAVX=0 -XX:-UseSSE42Intrinsics -XX:-TieredCompilation -Xcomp -XX:CompileCommand=compileonly,*::decodeArrayLoop TestUTF8DecodeMalformedIgnore
 * @run main/othervm -XX:+IgnoreUnrecognizedVMOptions -XX:UseAVX=1 -XX:-TieredCompilation -Xcomp -XX:CompileCommand=compileonly,*::decodeArrayLoop TestUTF8DecodeMalformedIgnore
 * @run main/othervm -XX:+IgnoreUnrecognizedVMOptions -XX:UseAVX=2 -XX:-TieredCompilation -Xcomp -XX:CompileCommand=compileonly,*::decodeArrayLoop TestUTF8DecodeMalformedIgnore
 * @run main/othervm -XX:+IgnoreUnrecognizedVMOptions -XX:UseAVX=0 -XX:-UseSSE42Intrinsics -XX:-TieredCompilation -Xcomp -XX:CompileCommand=compileonly,*::decodeArrayLoop TestUTF8DecodeMalformedIgnore prefix1
 * @run main/othervm -XX:+IgnoreUnrecognizedVMOptions -XX:UseAVX=1 -XX:-TieredCompilation -Xcomp -XX:CompileCommand=compileonly,*::decodeArrayLoop TestUTF8DecodeMalformedIgnore prefix1
 * @run main/othervm -XX:+IgnoreUnrecognizedVMOptions -XX:UseAVX=2 -XX:-TieredCompilation -Xcomp -XX:CompileCommand=compileonly,*::decodeArrayLoop TestUTF8DecodeMalformedIgnore prefix1
 * @run main/othervm -XX:+IgnoreUnrecognizedVMOptions -XX:UseAVX=0 -XX:-UseSSE42Intrinsics -XX:-TieredCompilation -Xcomp -XX:CompileCommand=compileonly,*::decodeArrayLoop TestUTF8DecodeMalformedIgnore prefix2
 * @run main/othervm -XX:+IgnoreUnrecognizedVMOptions -XX:UseAVX=1 -XX:-TieredCompilation -Xcomp -XX:CompileCommand=compileonly,*::decodeArrayLoop TestUTF8DecodeMalformedIgnore prefix2
 * @run main/othervm -XX:+IgnoreUnrecognizedVMOptions -XX:UseAVX=2 -XX:-TieredCompilation -Xcomp -XX:CompileCommand=compileonly,*::decodeArrayLoop TestUTF8DecodeMalformedIgnore prefix2
 *
 * @run main/othervm -XX:+IgnoreUnrecognizedVMOptions -XX:UseAVX=0 -XX:-UseSSE42Intrinsics -XX:TieredStopAtLevel=1 -Xcomp -XX:CompileCommand=compileonly,*::decodeArrayLoop TestUTF8DecodeMalformedIgnore
 * @run main/othervm -XX:+IgnoreUnrecognizedVMOptions -XX:UseAVX=1 -XX:TieredStopAtLevel=1 -Xcomp -XX:CompileCommand=compileonly,*::decodeArrayLoop TestUTF8DecodeMalformedIgnore
 * @run main/othervm -XX:+IgnoreUnrecognizedVMOptions -XX:UseAVX=2 -XX:TieredStopAtLevel=1 -Xcomp -XX:CompileCommand=compileonly,*::decodeArrayLoop TestUTF8DecodeMalformedIgnore
 * @run main/othervm -XX:+IgnoreUnrecognizedVMOptions -XX:UseAVX=0 -XX:-UseSSE42Intrinsics -XX:TieredStopAtLevel=1 -Xcomp -XX:CompileCommand=compileonly,*::decodeArrayLoop TestUTF8DecodeMalformedIgnore prefix1
 * @run main/othervm -XX:+IgnoreUnrecognizedVMOptions -XX:UseAVX=1 -XX:TieredStopAtLevel=1 -Xcomp -XX:CompileCommand=compileonly,*::decodeArrayLoop TestUTF8DecodeMalformedIgnore prefix1
 * @run main/othervm -XX:+IgnoreUnrecognizedVMOptions -XX:UseAVX=2 -XX:TieredStopAtLevel=1 -Xcomp -XX:CompileCommand=compileonly,*::decodeArrayLoop TestUTF8DecodeMalformedIgnore prefix1
 * @run main/othervm -XX:+IgnoreUnrecognizedVMOptions -XX:UseAVX=0 -XX:-UseSSE42Intrinsics -XX:TieredStopAtLevel=1 -Xcomp -XX:CompileCommand=compileonly,*::decodeArrayLoop TestUTF8DecodeMalformedIgnore prefix2
 * @run main/othervm -XX:+IgnoreUnrecognizedVMOptions -XX:UseAVX=1 -XX:TieredStopAtLevel=1 -Xcomp -XX:CompileCommand=compileonly,*::decodeArrayLoop TestUTF8DecodeMalformedIgnore prefix2
 * @run main/othervm -XX:+IgnoreUnrecognizedVMOptions -XX:UseAVX=2 -XX:TieredStopAtLevel=1 -Xcomp -XX:CompileCommand=compileonly,*::decodeArrayLoop TestUTF8DecodeMalformedIgnore prefix2
 * @summary test ignore mode case for UTF8 decoder
 */
...
public class TestUTF8DecodeMalformedIgnore {
